...
function WelcomeHint() {
  return (
    <div className="mx-auto flex h-full max-w-2xl flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <p className="mt-2 max-w-md text-sm text-text-secondary">
        Спросите GigaChat о чём угодно: от объяснения концепций до генерации кода и анализа текстов.
      </p>
...
const suggestions = [
  ...
  {
    title: 'Придумай план проекта',
    hint: 'Разбей задачу на этапы с оценками трудозатрат',
  },
];
